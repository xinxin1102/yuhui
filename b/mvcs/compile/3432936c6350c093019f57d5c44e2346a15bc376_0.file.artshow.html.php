<?php
/* Smarty version 3.1.30, created on 2017-03-17 08:27:59
  from "E:\wamp\wamp\www\mvcs\template\index\artshow.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58cb8fffdf2026_72227762',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3432936c6350c093019f57d5c44e2346a15bc376' => 
    array (
      0 => 'E:\\wamp\\wamp\\www\\mvcs\\template\\index\\artshow.html',
      1 => 1489728743,
      2 => 'file',
    ),
  ),
...
function content_58cb8fffdf2026_72227762 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="info">
        <span>
            <?php if (isset($_smarty_tpl->tpl_vars['category']->value[0])) {?>
                <?php echo $_smarty_tpl->tpl_vars['category']->value[0]["cname"];?>
        ...
        <span class="time">
            <?php echo $_smarty_tpl->tpl_vars['result']->value[0]["stime"];?>
...
<div class="otherinfo">
    <div class="buttons">
        ...
        <input type="button" class="btn btn-default select love_author" id="love_author" value="关注">
        ...
        <input type="button" class="btn btn-default select" id="love_article" value="收藏">
        ...
        <li style="display:none">
            ...
            <div class="liuyan_contentbox">
                ...
                <div class="gongneng">
                    ...
                    <input type="button" class="btn btn-default btn-sm" value="回复" reply_id="" >
                </div>
            </div>
        </li>
...
楼&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['v']->value["mtime"];?>

                        <!--第<span>{}</span>条回复-->
                    </div>
                    <input type="button" class="btn btn-default btn-sm" value="回复" reply_id="<?php echo $_smarty_tpl->tpl_vars['v']->value['mid'];?>
" >
                </div>
            </div>
            <!--子集留言 start-->
...
楼&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['v1']->value["mtime"];?>

                            <!--第<span>{}</span>条回复-->
                        </div>
                        <input type="button" class="btn btn-default btn-sm" value="回复" reply_id="<?php echo $_smarty_tpl->tpl_vars['v1']->value['mid'];?>
">
                    </div>
                </div>
            </div>
